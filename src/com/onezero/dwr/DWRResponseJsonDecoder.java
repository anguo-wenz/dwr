...
public class DWRResponseJsonDecoder {
    ...
    public static void main(String[] args) {
        ...
        DWRResponseJsonDecoder decoder = new DWRResponseJsonDecoder();
    ...
    private DWRResponseJsonDecoder() {

    }

    private static final DWRResponseJsonDecoder INSTANCE = new DWRResponseJsonDecoder();

    public static DWRResponseJsonDecoder getInstance() {
        return INSTANCE;
    }
    ...
    private JSONArray parseArray(String reply, String body) {
        //var s0={};
    ...
    private JSONObject parseObject(String reply, String body) {
        // var s0=[];
    ...
    private List<Object> parseReply(String reply) {
        ...
        for (String line : lines) {
            ...
            if (matcher.matches()) {
                ...
                setValue(references, ref, new JSONArray());
                continue;
            }
            ...
            if (matcher.matches()) {
                int ref = Integer.parseInt(matcher.group(1));
                setValue(references, ref, new JSONObject());
                continue;
            }
            ...
            if (matcher.matches()) {
                ...
                Object obj = parseValue(value, references);
                ((JSONArray) references.get(ref)).put(index, obj);
                continue;
            }
            ...
            if (matcher.matches()) {
                ...
                String value = matcher.group(3);
                Object obj = parseValue(value, references);
                ((JSONObject) references.get(ref)).put(field, obj);
                continue;
            }
        }
        return references;
